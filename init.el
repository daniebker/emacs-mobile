 ...
 '(hl-todo-keyword-faces
   (quote
    (("TODO" . "#dc752f")
     ...
     ("XXXX" . "#dc752f")
     ("???" . "#dc752f"))))
 '(org-agenda-files (quote ("~/notes/diary/gtd.org")))
 '(org-modules
   (quote
    (org-bbdb org-bibtex org-docview org-gnus org-habit org-info org-irc org-mhe org-rmail org-w3m)))
 '(package-selected-packages (quote (dracula-theme spacemacs-theme ox-hugo)))
...
(setq org-capture-templates
      '(("F" "Food Log" entry
        (file+datetree+prompt "~/notes/diary/food.org")
                "* %?\n%t\n%^{Meal}p%^{Type}p"))
	)
